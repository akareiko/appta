...
var SubscriptionCards: [SubscriptionCardModel] = [
    ...
    .init(image: "", color: "starbucks-black", frontimage: "", pattern: "subscriptioncard-pattern01", text1: "Add a new subscription card of your favourite coffee shops", text2: "Elevate your coffee ritual and relish the goodness in every cup."),
]
