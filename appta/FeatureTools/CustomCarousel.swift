...
//  SomeExtra
//
//  Created by Assylzhan Tati on 9/29/23.
//
...
struct CustomCarousel<Content: View, Item, ID>: View where Item: RandomAccessCollection, ID: Hashable,Item.Element: Equatable {
    ...
    init(index: Binding<Int>, items: Item, spacing: CGFloat = 30, cardPadding: CGFloat = 30, id: KeyPath<Item.Element,ID>, @ViewBuilder content: @escaping (Item.Element, CGSize) -> Content) {
