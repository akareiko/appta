...
//    
//    @State var isClicked: [Option: Bool] = [:]
//    
//    @Binding var totalPrice: Int
//    @Binding var optionArray: [Option: OptionType]
//    
////    init(totalPrice: Binding<Int>, optionArray: Binding<[Option: OptionType]>) {
////        self._totalPrice = totalPrice
////        self._optionArray = optionArray
////        
////        var initialIsClicked: [Option: Bool] = [:]
////        for option in viewModel.options {
////            initialIsClicked[option] = false
////        }
////        _isClicked = State(initialValue: initialIsClicked)
////    }
//    
...
//                            viewModel.selectedEnlargedOption = thing
//                            if optionArray[viewModel.selectedOption] != viewModel.selectedEnlargedOption {
//                                optionArray[viewModel.selectedOption] = viewModel.selectedEnlargedOption
////                                isClicked[viewModel.selectedOption] = true
//                            } else {
//                                optionArray[viewModel.selectedOption] = viewModel.optionUltimates[viewModel.selectedOption]
////                                isClicked[viewModel.selectedOption] = false
//                            }
...
//                                .shadow(radius: 2)
////                                .scaleEffect((isClicked[viewModel.selectedOption] && viewModel.selectedEnlargedOption.id == thing.id) || optionArray[viewModel.selectedOption] == thing ? 1.1 : 1.0)
////                                .overlay{
////                                    if (isClicked[viewModel.selectedOption] && viewModel.selectedEnlargedOption.id == thing.id) || optionArray[viewModel.selectedOption] == thing {
////                                        RoundedRectangle(cornerRadius: 15)
////                                            .stroke(
...
////                                }
//                            
//                            Image((/*isClicked[viewModel.selectedOption] &&*/ viewModel.selectedEnlargedOption.id == thing.id) || optionArray[viewModel.selectedOption] == thing ? thing.image_gold : thing.image)
//                                .resizable()
////                                .scaleEffect((isClicked[viewModel.selectedOption] && viewModel.selectedEnlargedOption.id == thing.id) || optionArray[viewModel.selectedOption] == thing ? 1.1 : 1.0)
...
//                                    .font(.callout)
////                                    .foregroundColor(
////                                        (isClicked[viewModel.selectedOption] && viewModel.selectedEnlargedOption.id == thing.id) || optionArray[viewModel.selectedOption] == thing ? (thing.name == "Hot" ? .red : (thing.name == "Cold" ? .blue : Color("starbucks-rewardgold"))) : .black
////                                    )
//                                HStack(spacing: 3) {
//                                    Text(thing.price == nil ? "" : "+ \(String(thing.price ?? 0))")
//                                        .font(.callout)
////                                        .foregroundColor((isClicked[viewModel.selectedOption] && viewModel.selectedEnlargedOption.id == thing.id) || optionArray[viewModel.selectedOption] == thing ? Color("starbucks-rewardgold") : .black)
//                                    
