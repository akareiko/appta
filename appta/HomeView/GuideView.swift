                ...
                IntroView(intro: $activeIntro, size: size){
                    ...
                    VStack(spacing: 10){
                        ...
                        Button(action: {
                            ...
                            navigationState.navigateToContentView = true
                        }) {
                            Text("Continue")
                                .fontWeight(.semibold)
...
struct GuideView_Previews: PreviewProvider {
    static var previews: some View {
        let navigationState = NavigationState() // Create a NavigationState instance
        return GuideView(navigationState: navigationState)
    }
}
